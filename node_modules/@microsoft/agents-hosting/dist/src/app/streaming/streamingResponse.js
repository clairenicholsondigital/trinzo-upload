...
class StreamingResponse {
    ...
    loadDefaults(activity) {
        ...
        else if (agents_activity_1.Channels.Msteams === activity.channelIdChannel) {
        ...
        else if (agents_activity_1.Channels.Webchat === activity.channelId || agents_activity_1.Channels.Directline === activity.channelId || agents_activity_1.Channels.Emulator === activity.channelId) {
            this._isStreamingChannel = true;
            this._delayInMs = 500;
        }
        else {
