...
const WORKSTREAM_CONCEPTS = [
  ...
  { label: 'Alarm-code and clinical confirmation', profiles: ['technical_file_review'], pattern: /\b(?:alarm|mute button|clinical|flash|flashing|low priority|medium priority|high priority|code change)\b/i, requiredEvidencePattern: /\b(?:mute button|clinical|code change|flash)\b/i },
