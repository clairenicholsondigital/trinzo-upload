...
app.get('/staged-meeting-minutes/pre-testing', authRoutes.requireAuth, (req, res) => {
  sendView(res, 'staged-meeting-minutes-pre-testing.html').catch((error) => res.status(404).send(error.message));
});
