...
class StagedMeetingMinutesContractTest(unittest.TestCase):
    ...
    def test_staged_no_edit_endpoint_returns_browser_review_messages(self):
        ...
        self.assertIn("open_discussion_organizer", api)
    ...
    def test_staged_generation_has_visible_loading_state(self):
        ...
        self.assertIn("Generating objectives and summary with AI", page)
    ...
    def test_staged_review_uses_guided_locked_stage_flow(self):
        ...
        self.assertIn('data-action-row="remove"', page)
        self.assertIn('aria-label="Remove action"', page)
        self.assertNotIn('data-action-row="duplicate"', page)
        self.assertNotIn('data-action-row="delete"', page)
        ...
        self.assertIn("Remove this topic and move its points to Unassigned?", page)
