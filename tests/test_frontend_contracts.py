...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_meeting_minutes_agent_uses_evidence_backed_resumable_workflow(self):
        ...
        self.assertIn('min-height:40px;padding:.35rem .45rem;border-color:transparent', page)
        ...
        self.assertEqual(page.count('class="agent-edit-toggle-closed">Open<'), 2)
        self.assertEqual(page.count('class="agent-edit-toggle-open">Close<'), 2)
        self.assertEqual(page.count('#i-chevron-down'), 2)
        self.assertIn('.agent-edit[open] .agent-edit-toggle .ic', page)
        self.assertIn('.topic-field input', page)
        self.assertIn('font-weight:var(--fw-bold)', page.split('.topic-field input', 1)[1].split('}', 1)[0])
        ...
        self.assertEqual(page.count('#i-download'), 2)
