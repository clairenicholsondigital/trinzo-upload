...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_meeting_minutes_agent_uses_evidence_backed_resumable_workflow(self):
        ...
        self.assertIn("Continuing now", client)
        self.assertNotIn("Retrying the agent now", client)
        ...
        self.assertIn("if (open.length && wasHidden) panel.open = false", client)
        self.assertIn("add:'New item'", client)
        self.assertIn("modify:'Edit'", client)
        self.assertIn("remove:'Removal'", client)
        self.assertNotIn('Suggested removal', client)
        ...
        self.assertIn("+ ' to review'", client)
        ...
        self.assertIn("function renderPageHeading()", client)
        self.assertIn("Preparing summary…", client)
        self.assertIn('id="summaryFields"', page)
        self.assertIn('.meeting-agent-page.has-draft .hero h1', page)
