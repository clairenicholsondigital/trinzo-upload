...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_meeting_minutes_final_queue_and_jobs_page_are_wired(self):
        ...
        self.assertIn('id="discussionList"', staged_page)
        self.assertIn('id="addDiscussionTopicBtn"', staged_page)
        ...
        self.assertIn("Remove this topic and move its points to Unassigned?", staged_page)
        ...
        self.assertIn('data-action-row="remove"', staged_page)
        self.assertIn('aria-label="Remove action"', staged_page)
        self.assertNotIn('data-action-row="duplicate"', staged_page)
        self.assertNotIn('data-action-row="delete"', staged_page)
    ...
    def test_staged_discussion_controls_and_terminology_jump_are_wired_to_cards(self):
        ...
        self.assertIn('class="discussion-card" open data-discussion-index=', staged_page)
