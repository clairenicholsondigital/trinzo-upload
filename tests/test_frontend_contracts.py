...
class FrontendContractTest(unittest.TestCase):
    def test_meeting_minutes_agent_uses_guided_minilm_and_copilot_workflow(self):
        ...
        self.assertIn("denoisedTranscript: state.denoisedTranscript", client)
        self.assertIn("agentRetryDelaysSeconds = [5, 15, 30]", client)
        self.assertIn("function waitForAgentRetry", client)
        self.assertIn("Retrying with a fresh agent conversation now", client)
        ...
        self.assertIn('Other evidenced person…', client)
        self.assertIn('data-deadline-picker type="date"', client)
        self.assertIn("function participantNames", client)
        self.assertIn("min-height:142px", page)
