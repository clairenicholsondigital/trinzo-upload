...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertIn(">Process meeting</a>", workspace_shell)
        self.assertIn(">Reports</a>", workspace_shell)
        self.assertLess(workspace_shell.index(">Overview</a>"), workspace_shell.index(">Process meeting</a>"))
        self.assertLess(workspace_shell.index(">Process meeting</a>"), workspace_shell.index(">Reports</a>"))
