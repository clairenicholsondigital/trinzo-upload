...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertLess(workspace_shell.index(">Overview</a>"), workspace_shell.index(">Process meeting</span></a>"))
        self.assertLess(workspace_shell.index(">Process meeting</span></a>"), workspace_shell.index(">Reports</a>"))
        self.assertIn('class="project-nav-link icon-only"', workspace_shell)
        self.assertIn('aria-label="Settings"', workspace_shell)
        self.assertIn("&#9881;", workspace_shell)
        self.assertNotIn('data-project-nav="settings">Settings</a>', workspace_shell)
        ...
        self.assertIn("Project status", workspace_shell)
        self.assertIn("Query project memory", workspace_shell)
        ...
        self.assertIn("Settings", workspace_shell)
        self.assertIn("Milestones & project memory", workspace_shell)
    ...
    def test_project_update_browsing_routes_are_registered(self):
        ...
        self.assertIn("Project milestones", insights_stage)
        self.assertNotIn("Profile milestones", insights_stage)
        ...
        self.assertIn("Add to monitored risks", insights_stage)
        self.assertIn("Suggested risk added to monitored risks", insights_stage)
        ...
        self.assertLess(insights_stage.index("Milestone progress"), insights_stage.index("Project milestones"))
        self.assertLess(insights_stage.index("Project milestones"), insights_stage.index("Configured risks"))
        self.assertIn("Project settings", settings_stage)
        ...
        self.assertIn("data-expand-edit-row>Open row</button>", insights_stage)
        self.assertNotIn("data-expand-edit-row>Expand</button>", insights_stage)
        self.assertNotIn("Expanded row editor", insights_stage)
        self.assertIn("openRowEditModal", insights_stage)
        self.assertIn("row-edit-modal-backdrop", workspace_page)
        self.assertIn("Apply to row", insights_stage)
        self.assertIn("monitor-checkbox", insights_stage)
        self.assertIn("profile-risk-table", insights_stage)
        self.assertIn("profile-milestone-table", insights_stage)
        self.assertIn("profile-monitor-column", insights_stage)
        ...
        self.assertIn("Included", setup_stage)
