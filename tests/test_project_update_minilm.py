...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertIn('<details class="support-details raw-json">', shared_js)
        self.assertIn('Support / audit details', shared_js)
    ...
    def test_project_update_browsing_routes_are_registered(self):
        ...
        self.assertIn("Support / audit details", reports_page)
        self.assertIn("support-details", reports_page)
