...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertIn("Project details & danger zone", workspace_shell)
        ...
        self.assertIn(".supporting-tools .stage-tabs { display:grid; grid-template-columns:1fr", page)
        self.assertIn(".supporting-tools .stage-tab { width:100%; align-items:flex-start; white-space:normal;", page)
        self.assertIn(".supporting-tools .stage-tab .step-hint { display:block; overflow-wrap:anywhere; line-height:1.25;", page)
