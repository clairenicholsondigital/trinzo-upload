...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertIn("title: 'Project update reporting'", process_stage)
        self.assertIn("Create a draft update report", process_stage)
        self.assertIn("evidence must come from this transcript", process_stage)
        ...
        self.assertIn("Process", workspace_shell)
        self.assertIn("Reports", workspace_shell)
        self.assertIn("Insights", workspace_shell)
    ...
    def test_project_update_browsing_routes_are_registered(self):
        ...
        self.assertIn("The tables below are the normal report view.", reports_page)
        self.assertIn("Advanced report data", reports_page)
