...
class ProjectUpdateMiniLMWorkflowTest(unittest.TestCase):
    ...
    def test_project_update_page_enables_editable_report_ui(self):
        ...
        self.assertIn("PROJECT_NAV", workspace_shell)
        self.assertIn("Overview", workspace_shell)
        self.assertIn("Reports", workspace_shell)
        self.assertIn("Ask", workspace_shell)
        self.assertIn("Switch project", workspace_shell)
        self.assertIn("target=\"_blank\"", workspace_shell)
        self.assertIn("project-switch-link", workspace_shell)
        self.assertIn("project-nav-link", workspace_shell)
        ...
        self.assertIn("window.ProjectStages.ask", (REPO_DIR / "public" / "project-stage-ask.js").read_text(encoding="utf-8"))
        self.assertIn("Ask this project", (REPO_DIR / "public" / "project-stage-ask.js").read_text(encoding="utf-8"))
    ...
    def test_project_update_browsing_routes_are_registered(self):
        ...
        self.assertNotIn("insights-header-panel", insights_stage)
        ...
        self.assertLess(insights_stage.index("At a glance"), insights_stage.index("Profile milestones"))
        self.assertLess(insights_stage.index("Project health overview"), insights_stage.index("Profile milestones"))
        self.assertIn("Project settings", settings_stage)
